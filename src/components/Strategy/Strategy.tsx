...
export function Strategy(){
    ...
    return(
        ...
        <div className="container items-center grid gap-10 grid-cols-1 md:grid-cols-2">
            <div className="left">
                <h2 className="items-start mb-7">Here are 3 working steps to organize our projects.</h2>
                <p className="mb-5">nean eu leo quam. Pellentesque ornare sem lacinia quam venenatis
                ...
                <p className="mb-5">Nullam id dolor id nibh ultricies vehicula ut id elit. 
